...
{
    options.AddPolicy("AdminWeb", cors =>
    {
...
{
    options.AddPolicy(AppPolicies.DeviceRead, policy => policy.RequireRole(AppRoles.Admin, AppRoles.Operator, AppRoles.Viewer));
    options.AddPolicy(AppPolicies.DeviceWrite, policy => policy.RequireRole(AppRoles.Admin, AppRoles.Operator));
    options.AddPolicy(AppPolicies.DashboardRead, policy => policy.RequireRole(AppRoles.Admin, AppRoles.Operator, AppRoles.Viewer));
    options.AddPolicy(AppPolicies.AuditRead, policy => policy.RequireRole(AppRoles.Admin, AppRoles.Operator));
